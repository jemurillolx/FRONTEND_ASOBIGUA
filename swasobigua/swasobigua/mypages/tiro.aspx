    ...
    <form id="form1" runat="server">
        <div>
            ...
            <script type="text/javascript">
                ...
                function digi(BackstrokePause, shotInterval, Jab, FollowThrough, TipSteer, Straightness, Finesse, Finish) {
                    var data = [
                        {
                            x: ['BackstrokePause', 'shotInterval', 'Jab', 'FollowThrough', 'TipSteer', 'Straightness', 'Finesse', 'Finish'],
                            y: [BackstrokePause, shotInterval, Jab, FollowThrough, TipSteer, Straightness, Finesse, Finish],
                            type: 'bar'
                        }
                    ];
      ...
      ================================================== -->
                ...
                <div class="container marketing">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <p>
                                 <asp:Label ID="Label4" runat="server" Text="Nombre Jugador:" Font-Bold="True" ForeColor="White"></asp:Label>
                        ...
                        <div class="col-lg-6">
                            <p>
                                <asp:Label ID="Label5" runat="server" Text="Apellidos Jugador:" Font-Bold="True" ForeColor="White"></asp:Label>
                     ...
                     <div class="row">
                        <div class="col-lg-6">
                            <p>
                                 <asp:Label ID="Label6" runat="server" Text="Nombre Entrenador:" Font-Bold="True" ForeColor="White"></asp:Label>
                        ...
                        <div class="col-lg-6">
                            <p>
                                <asp:Label ID="Label7" runat="server" Text="Apellidos Entrenador:" Font-Bold="True" ForeColor="White"></asp:Label>
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6">
                            <p>
                                 <asp:Label ID="Label8" runat="server" Text="Fecha Hora:" Font-Bold="True" ForeColor="White"></asp:Label>
                                 <asp:TextBox ID="tbxFecha" runat="server" CssClass="form-control input-lg " placeholder="Apellidos"></asp:TextBox>
                            </p>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <p>
                                <asp:Label ID="Label1" runat="server" Text="Taco" Font-Bold="True" ForeColor="White"></asp:Label>
                            </p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <p>
                                ...
                                <%--<iframe width="100%" height="500px" src="others/test3.html" runat="server" ID="digi"></iframe>--%>
                            </p>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <p>
                                <asp:Label ID="lbljugador" runat="server" Text="Muñeca" Font-Bold="True" ForeColor="White"></asp:Label>
                            </p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <p>
                                ...
                                <%--<iframe width="100%" height="500px" src="others/test.html" runat="server" id="mtbrazo"></iframe>--%>
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <p>
                                <asp:Label ID="Label2" runat="server" Text="Antebrazo" Font-Bold="True" ForeColor="White"></asp:Label>
                            </p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <p>
                                <asp:Label ID="Label3" runat="server" Text="Pierna" Font-Bold="True" ForeColor="White"></asp:Label>
                            </p>
